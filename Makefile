...
SRC_FILES += \
  ...
  $(NORDIC_SDK_PATH)/components/libraries/log/src/nrf_log_backend_rtt.c \
  $(NORDIC_SDK_PATH)/components/libraries/log/src/nrf_log_backend_serial.c \
  $(NORDIC_SDK_PATH)/components/libraries/log/src/nrf_log_backend_uart.c \
  ...
  $(NORDIC_SDK_PATH)/components/libraries/pwr_mgmt/nrf_pwr_mgmt.c \
  $(NORDIC_SDK_PATH)/components/libraries/ringbuf/nrf_ringbuf.c \
  $(NORDIC_SDK_PATH)/components/libraries/experimental_section_vars/nrf_section_iter.c \
  $(NORDIC_SDK_PATH)/components/libraries/strerror/nrf_strerror.c \
  $(NORDIC_SDK_PATH)/integration/nrfx/legacy/nrf_drv_ppi.c \
  $(NORDIC_SDK_PATH)/integration/nrfx/legacy/nrf_drv_uart.c \
...
INC_FOLDERS += \
  ...
  $(NORDIC_SDK_PATH)/components/libraries/pwr_mgmt \
  ...
  $(NORDIC_SDK_PATH)/components/libraries/mutex \
  $(NORDIC_SDK_PATH)/components/libraries/delay \
